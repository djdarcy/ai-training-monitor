#!/bin/bash
#
# Install git hooks for AI Training Monitor project
#
...
echo -e "${BLUE}AI Training Monitor Git Hook Installer${NC}"
echo "======================================="
echo ""
...
echo "  Example: 0.1.0-alpha_main_42-20250918-a1b2c3d4"
#!/bin/bash
#
# Manual version update script for AI Training Monitor
...
if [ "$AUTO_MODE" = false ]; then
    ...
    echo -e "${BLUE}AI Training Monitor Version Updater${NC}"
    echo "======================================"
else
    RED=''
    GREEN=''
...
# Configuration
SOURCE_FILE="ai_training_monitor/version.py"
...
if [ ! -f "$SOURCE_FILE" ]; then
    ...
    if [ -f "../$SOURCE_FILE" ]; then
        cd ..
    elif [ -f "../ai_training_monitor/version.py" ]; then
        cd ..
        SOURCE_FILE="ai_training_monitor/version.py"
    else

...
PHASE = "alpha"  # Currently in alpha phase
...
__version__ = "0.1.0-alpha_private_12-20250918-4a55714b"
...
def get_base_version():
    ...
    # Example: 0.1.0_private_13-20250918-ad442287 -> 0.1.0
    if '_' in __version__:
...
def get_pip_version():
    ...
    - Main branch: 0.1.0_main_13-20250918-hash → 0.1.0
    - Dev branch: 0.1.0_private_13-20250918-hash → 0.1.0.dev13
    - Feature branch: 0.1.0_feature_13-20250918-hash → 0.1.0.dev13+feature
    """
